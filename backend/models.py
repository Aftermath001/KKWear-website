...
class Business(Model):
    ...
    city = fields.CharField(max_length =100, null= False, udefault = "Unspecified")
    region = fields.CharField(max_length =100, null= False, udefault = "Unspecified")
    business_descrption = fields.TextField(null = True)
